...
This means one can have an always-on powocoind instance running, and another local powocoind/powocoin-qt instance which connects to this node and receives blocks from it.
