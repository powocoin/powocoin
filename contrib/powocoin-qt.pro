...
RESOURCES += src/qt/powocoin.qrc src/qt/powocoin_locale.qrc

TRANSLATIONS += src/qt/locale/powocoin_bg.ts \
                src/qt/locale/powocoin_de.ts \
                src/qt/locale/powocoin_en.ts \
                src/qt/locale/powocoin_es.ts \
                src/qt/locale/powocoin_fi.ts \
                src/qt/locale/powocoin_fr.ts \
                src/qt/locale/powocoin_it.ts \
                src/qt/locale/powocoin_ja.ts \
                src/qt/locale/powocoin_pl.ts \
                src/qt/locale/powocoin_pt.ts \
                src/qt/locale/powocoin_ru.ts \
                src/qt/locale/powocoin_sk.ts \
                src/qt/locale/powocoin_sv.ts \
                src/qt/locale/powocoin_vi.ts \
                src/qt/locale/powocoin_zh_CN.ts \
                src/qt/locale/powocoin_zh_TW.ts
