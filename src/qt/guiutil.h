...
/** Utility functions used by the Powocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Powocoin addresses in monospace font
...
// Parse "powocoin:" URI into recipient object, return true on successful parsing
