                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Powocoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Powocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and powocoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Powocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Powocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Powocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Powocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Powocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Powocoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Powocoin Core help message to get a list with possible Powocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Powocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Powocoin network", "", count));
}
...
{
    QString strTitle = tr("Powocoin Core"); // default title
