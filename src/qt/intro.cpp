...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Powocoin Core"),
     ...
     * override -datadir in the powocoin.conf file in the default data directory
     * (to be consistent with powocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
