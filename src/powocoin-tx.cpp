...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Powocoin Core powocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  powocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded powocoin transaction") + "\n" +
                               "  powocoin-tx [options] -create [commands]   " + _("Create hex-encoded powocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded powocoin transaction
