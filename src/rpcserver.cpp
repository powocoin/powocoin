...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Powocoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Powocoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Powocoin features */
        {"powocoin", "masternode", &masternode, true, true, false},
        {"powocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"powocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"powocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"powocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"powocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"powocoin", "startmasternode", &startmasternode, true, true, false},
        {"powocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"powocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"powocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"powocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"powocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"powocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"powocoin", "mnbudget", &mnbudget, true, true, false},
        {"powocoin", "preparebudget", &preparebudget, true, true, false},
        {"powocoin", "submitbudget", &submitbudget, true, true, false},
        {"powocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"powocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"powocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"powocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"powocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"powocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"powocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"powocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"powocoin", "mnsync", &mnsync, true, true, false},
        {"powocoin", "spork", &spork, true, true, false},
        {"powocoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"powocoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use powocoind, or the -server option to powocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> powocoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18883/\n";
}
