...
/** 
    ...
    ****Note - for Powocoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of powocoin coming in to a transaction
