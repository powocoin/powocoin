Powocoin Core version 2.3.1 is now available from:

  <https://github.com/powocoin-project/powocoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/powocoin-project/powocoin/issues>

Compatibility
==============

Powocoin Core is extensively tested on multiple operating systems using
...
Powocoin Core should also work on most other Unix-like systems but is not
...
Examples:
> powocoin-cli masternodestart "alias" "my_mn"
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "masternodestart", "params": ["alias" "my_mn"] }' -H 'content-type: text/plain;' http://127.0.0.1:18883/
```
...
Examples:
> powocoin-cli mnvote "local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "mnvote", "params": ["local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"] }' -H 'content-type: text/plain;' http://127.0.0.1:18883/
```
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) Powocoin address of payment
...
Examples:
> powocoin-cli getbudgetprojection
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getbudgetprojection", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:18883/
```
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/powocoin-project-translations/).
