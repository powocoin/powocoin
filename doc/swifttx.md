...
This mechanism has been integrated into Bitcore-Node-Powocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Powocoin-Project/insight-api-powocoin#web-socket-api](https://github.com/Powocoin-Project/insight-api-powocoin#web-socket-api) 
* API: [https://github.com/Powocoin-Project/insight-api-powocoin#swifttx-transactions](https://github.com/Powocoin-Project/insight-api-powocoin#swifttx-transactions) 
...
By default, the Powocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Powocoin Core daemon:
