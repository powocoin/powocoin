...
In order to support loading of multiple wallets in powocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is powocoin.cpp.
...
Changes to powocoin.cpp
----------------------
powocoin.cpp is the entry point into powocoin-qt, and as such, will require some minor modifications to provide hooks for
